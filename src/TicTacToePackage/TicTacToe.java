...
//    }
//
//        public void play1 (int playerId, int playerPosition){
        ...
        if(playerId > 2 && playerPosition > 9){
            throw new InvalidPlayerAndInvalidPlayerPosition("playerid should be between 1 and 2: and player POSITION SHOULD NOT BE MORE THAN NINE");
        }
        }
    }
}
